...
tip
Message `content` can contain both text and [content blocks](https://python.langchain.com/docs/concepts/messages/#aimessage) with additional structure. See [this guide](https://python.langchain.com/docs/how_to/output_parser_string/) for more information.